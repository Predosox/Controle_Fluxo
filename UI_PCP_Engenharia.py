...
################################################################################
## Form generated from reading UI file 'PCP_Check_Engenharia.ui'
##
...
class UI_PCP_Engenharia(object):
...
"border-radius: 10px")
        ...
        __qtreewidgetitem.setFont(6, font2);
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" color:#ffffff;\">ENGENHARIA</span></p></body></html>", None))
        ___qtreewidgetitem = self.treeWidget.headerItem()
        ___qtreewidgetitem.setText(7, QCoreApplication.translate("MainWindow", u"Atualiza\u00e7\u00e3o", None));
        ___qtreewidgetitem.setText(6, QCoreApplication.translate("MainWindow", u"Unidade", None));
        ___qtreewidgetitem.setText(5, QCoreApplication.translate("MainWindow", u"Quantidade", None));
        ___qtreewidgetitem.setText(4, QCoreApplication.translate("MainWindow", u"Nome Mat\u00e9ria Prima", None));
        ___qtreewidgetitem.setText(3, QCoreApplication.translate("MainWindow", u"C\u00f3digo Mat\u00e9ria Prima", None));
        ___qtreewidgetitem.setText(2, QCoreApplication.translate("MainWindow", u"Nome do item", None));
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("MainWindow", u"C\u00f3digo do item", None));
