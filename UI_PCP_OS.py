...
################################################################################
## Form generated from reading UI file 'PCP_OS.ui'
##
...
"border-radius: 15px; /* Arredondamento das bordas *")
        ...
        self.Btn_Voltar_Login = QPushButton(self.centralwidget)
        self.Btn_Voltar_Login.setObjectName(u"Btn_Voltar_Login")
        self.Btn_Voltar_Login.setGeometry(QRect(690, 560, 101, 31))
        self.Btn_Voltar_Login.setFont(font)
        self.Btn_Voltar_Login.setStyleSheet(u"background-color:rgb(248, 121, 8);\n"
"color: rgb(255, 255, 255);\n"
"border-radius: 10px")
        self.Btn_Checar = QPushButton(self.centralwidget)
        self.Btn_Checar.setObjectName(u"Btn_Checar")
        self.Btn_Checar.setGeometry(QRect(690, 520, 101, 31))
...
"border-radius: 10px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Label_Telefone.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; color:#ffffff;\">OS:</span></p></body></html>", None))
        ...
        self.Btn_Voltar_Login.setText(QCoreApplication.translate("MainWindow", u"VOLTAR", None))
