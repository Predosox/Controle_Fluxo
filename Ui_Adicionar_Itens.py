...
"border-radius: 10px")
        self.Edit_Vendedor = QLineEdit(self.centralwidget)
        self.Edit_Vendedor.setObjectName(u"Edit_Vendedor")
        self.Edit_Vendedor.setGeometry(QRect(310, 310, 181, 51))
        self.Edit_Vendedor.setStyleSheet(u"background-color:rgba(214, 214, 214,0.8); /* Cor de fundo azul */\n"
"border-radius: 15px; /* Arredondamento das bordas *")
        self.Edit_Vendedor.setAlignment(Qt.AlignCenter)
        self.Edit_CNPJ = QLineEdit(self.centralwidget)
        self.Edit_CNPJ.setObjectName(u"Edit_CNPJ")
        self.Edit_CNPJ.setGeometry(QRect(310, 390, 181, 51))
...
"border-radius: 15px; /* Arredondamento das bordas *")
        ...
        self.Edit_NumeroPedido = QLineEdit(self.centralwidget)
        self.Edit_NumeroPedido.setObjectName(u"Edit_NumeroPedido")
        self.Edit_NumeroPedido.setGeometry(QRect(310, 230, 181, 51))
        self.Edit_NumeroPedido.setStyleSheet(u"background-color:rgba(214, 214, 214,0.8); /* Cor de fundo azul */\n"
"border-radius: 15px; /* Arredondamento das bordas *")
        self.Edit_NumeroPedido.setAlignment(Qt.AlignCenter)
        self.Edit_OS = QLineEdit(self.centralwidget)
        self.Edit_OS.setObjectName(u"Edit_OS")
        self.Edit_OS.setGeometry(QRect(310, 150, 181, 51))
...
"border-radius: 15px; /* Arredondamento das bordas *")
        ...
        self.Label_NomeEmpresa.setGeometry(QRect(320, 130, 161, 16))
        font1 = QFont()
        font1.setBold(True)
        ...
        self.Label_Telefone.setGeometry(QRect(320, 210, 161, 16))
...
"border-radius: 10px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Edit_Vendedor.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Digite Aqui", None))
        self.Edit_CNPJ.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Digite Aqui", None))
        self.Edit_NumeroPedido.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Digite Aqui", None))
        self.Edit_OS.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Digite Aqui", None))
        self.Label_NomeEmpresa.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; color:#ffffff;\">OS</span></p></body></html>", None))
        self.Label_Telefone.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; color:#ffffff;\">N\u00daMERO DO PEDIDO</span></p></body></html>", None))
        self.Label_Endereco.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; color:#ffffff;\">CNPJ DO CLIENTE</span></p></body></html>", None))
        self.Label_Cep.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; color:#ffffff;\">VENDEDOR(A)</span></p></body></html>", None))
