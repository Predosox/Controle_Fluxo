...
################################################################################
## Form generated from reading UI file 'PCP_Check_Vendas.ui'
##
...
class Ui_Vendas_PCP_Check(object):
...
"border-radius: 10px")
        ...
        __qtreewidgetitem.setFont(9, font2);
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" color:#ffffff;\">VENDAS</span></p></body></html>", None))
